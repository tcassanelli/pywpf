...
file_name = 'rmr3000'  # Contains the time array
output_name = file_name + '_test87'

# Number of rows in waterfall for second interation
interval_to_compute = [i for i in range(10, 12)]
...
titles = ('BINTIME', 'PERIOD_START', 'NUM_DIV', 'ITER1', 'DELTA1', \
    'PERIOD_ITER1', 'ITER2', 'DELTA2', 'PERIOD_ITER2')
...
for num_div in interval_to_compute:
    ...
    Per, [var_iter1, var_iter2], [scalar_iter1, scalar_iter2], [mstev_iter1, mstev_iter2], _ = find_period(time, period_start, dt, num_div, iter1, delta1, iter2, delta2, noisy_signal=noise_signal)
